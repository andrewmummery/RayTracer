...
where our co-ordinates are <a href="https://www.codecogs.com/eqnedit.php?latex=(t,&space;r,&space;\theta,&space;\phi)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?(t,&space;r,&space;\theta,&space;\phi)" title="(t, r, \theta, \phi)" /></a>
